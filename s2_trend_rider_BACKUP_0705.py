...
PATCH 2026-07-05: Loosened PULLBACK_TOLERANCE 0.01->0.03, VOLUME_MIN 1.2->0.8
to allow alt-coin signals during off-peak hours (low vol environment).
"""
...
PULLBACK_TOLERANCE = 0.03  # PATCHED 0.01->0.03: catches pullbacks in progress for alts
VOLUME_MIN = 0.80          # PATCHED 1.20->0.80: alts in off-peak hours won't hit 1.2x
...
class S2TrendRider:
    ...
    def generate(
        ...
        try:
            ...
            # Pullback: price within PULLBACK_TOLERANCE of the relevant AI ST band.
